        ...
        extends AbstractTestQueryFramework
{
            ...
            throws Exception
    {
        ...
        try {
            ...
            queryRunner.installPlugin(new TestingDeltaLakePlugin(dataDirectory, Optional.empty(), Optional.of(trackingFileSystemFactory), binder -> binder.bind(CachingHostAddressProvider.class).toInstance(NoneCachingHostAddressProvider.INSTANCE)));
