...
public class ConsistentHashingCachingHostAddressProvider
        implements CachingHostAddressProvider
{
    private static final Logger log = Logger.get(ConsistentHashingCachingHostAddressProvider.class);
    ...
    @Inject
    public ConsistentHashingCachingHostAddressProvider(NodeManager nodeManager)
    {
    ...
    {
        return consistentHashRing.locate(splitPath)
                .stream()
