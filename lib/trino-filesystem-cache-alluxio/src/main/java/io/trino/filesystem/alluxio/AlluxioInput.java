        ...
        implements TrinoInput
{
    ...
    public AlluxioInput(TrinoInputFile inputFile, URIStatus status,
            CacheManager cacheManager, AlluxioConfiguration configuration, AlluxioCacheStats statistics)
    {
            ...
            throws IOException
    {
        ...
        int bytesRead = 0;
        bytesRead += helper.doBufferRead(position + bytesRead, buffer, offset + bytesRead, length - bytesRead);
        bytesRead = addExact(bytesRead, helper.doCacheRead(position + bytesRead, buffer, offset + bytesRead, length - bytesRead));
        ...
        doExternalRead(position, buffer, offset, length - bytesRead);
    }
