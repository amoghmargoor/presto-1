        ...
        extends TrinoInputStream
{
    ...
    {
        int bytesRead = 0;
        bytesRead += helper.doBufferRead(position + bytesRead, bytes, offset + bytesRead, length - bytesRead);
        bytesRead = addExact(bytesRead, helper.doCacheRead(position + bytesRead, bytes, offset + bytesRead, length - bytesRead));
        bytesRead = addExact(bytesRead, doExternalRead(position + bytesRead, bytes, offset + bytesRead, length - bytesRead));
        return bytesRead;
    }
