        ...
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        newOptionalBinder(binder, CachingHostAddressProvider.class).setDefault().toInstance(NoneCachingHostAddressProvider.INSTANCE);
        newOptionalBinder(binder, CacheKeyProvider.class).setDefault().toInstance(DefaultCacheKeyProvider.INSTANCE);
