...
public class TestCacheFileSystemAccessOperations
{
    ...
    void setUp()
    {
        ...
        fileSystem = new CacheFileSystem(trackingFileSystemFactory.create(TestingSession.SESSION), new TestingMemoryFileSystemCache(), DefaultCacheKeyProvider.INSTANCE);
    }
